<?php 
include_once '../../controller/usuario/usuario_DAO.php';
?>
                           ...
                           <tbody>
                              ...
                              <tr class="row100 body">
                                 ...
                                 <td class="text-center">
                                    <a href="../../controller/usuario/usuario_controller.php?acao=delete&id=<?php echo $res['id'] ?>" name="acao" class="btn btn-sm btn-danger excluir-usuario" onClick="remover()">
